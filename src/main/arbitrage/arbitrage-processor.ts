        ...
        return this.exchangeManager.getExchangeOrdersByStatus(ExchangeOrder.Status.PLACED)
            ...
            .flatMap(Void => Observable.zip(
                ...
                (sourceExchangeBalance, destExchangeBalance) => {
                    sourceExchangeBalance = sourceExchangeBalance
                    destExchangeBalance = destExchangeBalance
                    ...
                    return Observable.zip(
                        ...
                        (sourceExchangeOrder, destExchangeOrder) => {
                            ...
                            sourceExchangeOrder.arbOpportunityId = arbOpportunity.id
                            ...
                            destExchangeOrder.arbOpportunityId = arbOpportunity.id
                            return Observable.from([sourceExchangeOrder, destExchangeOrder])
                                .flatMap(exchangeOrder => this.exchangeManager.saveExchangeOrder(exchangeOrder))
