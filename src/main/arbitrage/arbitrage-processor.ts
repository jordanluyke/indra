            ...
            .flatMap(exchangeRates => {
                ...
                return Observable.from(exchangePairs)
                    .flatMap(exchangePair => Observable.zip(
                        ...
                        .do(arbOpportunity => {
                            this.logger.debug("Arbitrage rate:",
                                ...
                                "|",
                                arbOpportunity.percentage.toFormat(3), "%")
                        })
                        .filter(arbOpportunity => arbOpportunity.percentage.comparedTo(this.config.minimumArbExecutionPercentage) >= 0)
